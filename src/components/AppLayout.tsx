  ...
  return (
    <div className="app-shell" >
      ...
      <div className="g-main" >
        {/* Topbar */}
        <header className="g-topbar" style={{
          ...
          {/* Search */}
          <div className="g-topbar__search" style={{
        ...
        <div className="g-content" style={{
          ...
          <div className="page-header">
            <div>
              <h1 className="page-title" style={{ fontSize: 22, fontWeight: 800, color: 'var(--text-primary)' }}>{title}</h1>
            </div>
